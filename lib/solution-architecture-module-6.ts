...
export const interventions: Record<string, Intervention> = {
  "m6-attributen-standard-v1": {
    ...
    kind: "explanation",
    body: "Een trade-off is niet een fout in het ontwerp, maar juist wat een echte ontwerpkeuze kenmerkt. Bij Middelveen kan het beperken van medische gegevens buiten de keuringsinstantie de vertrouwelijkheid verbeteren, terwijl beschikbaarheid en controle afnemen. De vaardigheid is daarom niet om alleen de winst te benoemen, maar ook het verlies expliciet te maken.",
  ...
  "m6-trade-off-repair-v1": {
    ...
    kind: "repair",
    body: "Als één optie aantoonbaar op ieder relevant punt beter is, heb je geen spanningsvolle ontwerpkeuze meer. Dan heb je eerder een gegeven vastgesteld. Eva gebruikt dit contrast om de misconceptie ‘trade-off = ontwerpfout’ te doorbreken.",
  ...
  "m6-alternatieven-standard-v1": {
    ...
    kind: "explanation",
    body: "Een ADR met slechts één oplossing laat niet zien wat werkelijk is afgewogen. Een werkbaar minimum is de voorkeursoptie plus minstens twee serieuze alternatieven: opties die een redelijk vakgenoot daadwerkelijk zou kunnen kiezen. Een stroman-alternatief telt niet als echte afweging.",
  ...
  "m6-alternatieven-genereren-v1": {
    ...
    kind: "explanation",
    body: "Voor statusterugkoppeling zijn drie verschillende richtingen reëel: rechtstreeks bevragen, gebeurtenissen publiceren, of status via een bestaand berichtenkanaal teruggeven. De derde optie is minder technisch, maar juist daarom een nuttig alternatief: hij vermijdt een extra online koppeling.",
  ...
  "m6-adr-anatomie-standard-v1": {
    ...
    kind: "explanation",
    body: "Een ADR legt één architectuurbeslissing compact vast. De vaste kern bestaat uit titel, status, context, beslissing en consequenties. Overwogen alternatieven, datum en eigenaar zijn waardevolle aanvullingen. Een ADR is bewust kort en is geen volledig ontwerpdocument.",
  ...
  "m6-adr-onderdelen-check-v1": {
    ...
    kind: "check",
    body: "ADR-07 bevat Context, Beslissing en Alternatieven. Eén verplicht onderdeel dat de gevolgen van de keuze zichtbaar maakt ontbreekt nog.",
    prompt: "Welk verplicht onderdeel mis je?",
    visual: { ...baseVisual, visibleAlternatives: 3, visibleAttributes: 2, showTradeoffs: true, adrSectionsVisible: ["titel", "context", "beslissing", "alternatieven"] },
  },
  "m6-attributen-recap-v1": {
    ...
    kind: "explanation",
    body: "Je kent de kern al: kwaliteitsattributen geven taal aan de winst en het verlies van een keuze. Een echte trade-off maakt zichtbaar welk attribuut je versterkt en welk attribuut je daarvoor belast.",
  ...
  "m6-consequenties-repair-v1": {
    ...
    kind: "repair",
    body: "Een ADR is geen verkooptekst voor de gekozen oplossing. Als Consequenties alleen positieve formuleringen bevat, ontbreekt het bewijs dat nadelen bewust zijn gezien en geaccepteerd. Voeg daarom expliciet lasten, nieuwe afhankelijkheden en operationele gevolgen toe.",
  ...
  "m6-adr-achteraf-repair-v1": {
    ...
    kind: "repair",
    body: "Een ADR die pas na de bouw wordt geschreven kan het dossier completeren, maar documenteert dan niet meer de feitelijke afweging. Het probleem is niet de vorm; de keuze is al gemaakt voordat alternatieven en consequenties transparant zijn beoordeeld.",
  ...
  "m6-veelgemaakte-fouten-deep-v1": {
    ...
    kind: "explanation",
    body: "Veel voorkomende zwaktes zijn: gewoonte als enige argument, een ADR achteraf, meerdere beslissingen in één record, een vage beslissing en consequenties zonder lasten. Een nieuwe beslissing overschrijft bovendien niet stilletjes de oude ADR; de oude krijgt de status dat hij is vervangen, zodat de redeneergeschiedenis leesbaar blijft.",
  ...
  "m6-alternatieven-transfer-v1": {
    ...
    kind: "practice",
    body: "Bedenk een vierde manier waarop Middelveen statusterugkoppeling zou kunnen organiseren. De toets is niet of jij hem mooi vindt, maar of een redelijk vakgenoot hem serieus zou kunnen kiezen en of je de consequenties op de relevante kwaliteitsattributen kunt benoemen.",
  ...
  "m6-adr-beoordelen-assessment-v1": {
    ...
    kind: "assessment",
    body: "De eindcheck blijft in iedere route verplicht. De antwoorden worden server-side beoordeeld; de sleutel staat niet in de lescomponent.",
    visual: { ...baseVisual, visibleAlternatives: 3, visibleAttributes: 4, showTradeoffs: true, adrSectionsVisible: adrSections },
  },
};
...
export const assessmentQuestions = [
  ...
  {
    id: "m6-assess-02",
    question: "Een ADR beschrijft Context, Beslissing en Alternatieven, maar niet wat de keuze daarna veroorzaakt. Welk kernonderdeel ontbreekt?",
