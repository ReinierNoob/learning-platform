...
import { adaptiveAccessStatus, adaptiveSolutionArchitectureCourseSlug, adaptiveModule2SourceModuleId, isAdaptivePersistenceEnabled } from "../../../../../lib/adaptive-runtime";
...
export async function GET() {
  ...
  try {
    ...
    const state = await buildAdaptiveModuleRestoreState(context, solutionArchitectureModule2);
    ...
    console.error("adaptive_module2_state_restore_failed", error);
