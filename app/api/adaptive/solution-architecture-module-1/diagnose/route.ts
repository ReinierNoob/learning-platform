...
import { diagnoseModule1, module1ClassifierVersion, module1OrchestratorVersion } from "../../../../../lib/solution-architecture-module-1-server";
...
export async function POST(request: Request) {
  ...
  const diagnosis = diagnoseModule1(body?.answers ?? {});
    ...
    try {
      ...
      const persisted = await persistAdaptiveTransitionForLearner(context, {
        profile: {
          ...
          routeState: { module: adaptiveModule1SourceModuleId, route: diagnosis.route, reasonCode: diagnosis.reasonCode, phase: "diagnosis" },
          preferences: {},
        },
        ...
        decision: {
          ...
          rationale: `Module 1 diagnosis selected route ${diagnosis.route}`,
      ...
      console.error("adaptive_module1_diagnosis_persistence_failed", error);
