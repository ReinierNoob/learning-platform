...
export const metadata = { title: "EAW Learning QA — Solution Architecture Module 9", description: "Preview-only QA-harness voor de adaptieve Module 9-runtime.", robots: { index: false, follow: false } };
