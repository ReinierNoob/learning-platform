...
export type VisualCue = VisualState & {
  atMs: number;
};
...
export const valueStages: ValueStage[] = [
...
const triggerExercise: SingleChoiceExercise = {
  type: "single-choice",
...
export const valueStreamLesson: LessonScene[] = [
  {
    id: "question",
    speaker: "interviewer",
    title: "De kernvraag",
